...
export const mockApplications: Application[] = [
  {
    ...
    cvSummary: '5 years of experience in React development with strong TypeScript skills.',
    ...
    validationResponses: [
      { question: 'Explain your experience with React hooks', answer: 'I have extensively used useState, useEffect, and custom hooks...' },
      { question: 'How do you handle state management?', answer: 'I prefer using Context API for simple apps and Redux for complex...' }
    ]
  },
  {
    id: 'app2',
    ...
    cvSummary: '4 years building scalable APIs with Node.js and microservices architecture.',
    validationStatus: 'completed',
