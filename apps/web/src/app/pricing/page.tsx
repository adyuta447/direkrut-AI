...
const features: {
  ...
  {
    label: "Upload lowongan",
    values: ["Maks. 2", "Maks. 10", "Unlimited", "Unlimited"],
  },
  {
    label: "Terima lamaran CV",
    values: ["500 MB", "5 GB", "20 GB", "Unlimited"],
  },
  ...
  {
    label: "Feedback otomatis kandidat",
    values: [false, "Dasar", "Lengkap", "Lengkap + Custom"],
  },
  {
    label: "Dashboard analytics HRD",
    values: [false, "Dasar", "Lengkap", "Lengkap + Export"],
  },
...
function FeatureCell({ value }: { value: FeatureValue }) {
  ...
  if (value === false) {
    return (
      <X
        className="w-4 h-4 text-ink-muted/50 mx-auto"
        strokeWidth={1.5}
      ...
      <FooterRevealBody>
        ...
        <section className="pt-14 pb-12 px-6 lg:px-10 max-w-[1584px] mx-auto">
          ...
          <p className="text-[17px] text-ink-muted leading-[1.7] max-w-2xl">
            Buat kandidat, Direkrut AI selalu gratis. Paket di bawah ini buat
            kamu yang lagi rekrut: dari yang baru buka lowongan pertama sampai
            yang hiring-nya nggak pernah berhenti.
          </p>
        </section>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {tiers.map((tier) => (
              ...
              >
                ...
                <p className="text-[13px] text-ink-muted mt-2 mb-6">
                  {tier.period}
                </p>
        ...
        <section className="pb-24 px-6 lg:px-10 max-w-[1584px] mx-auto">
          <div className="mb-10 max-w-3xl">
            ...
            <p className="text-[15px] text-ink-muted leading-[1.6]">
              Semua paket bisa di-upgrade kapan aja. Nggak cocok? Turun paket
              juga gampang.
            </p>
          </div>
          ...
          <p className="text-[13px] text-ink-muted mt-6">
            Harga masih estimasi dan bisa berubah. Butuh paket yang lebih
            custom? Ngobrol sama kami dulu aja, gratis kok.
          </p>
        </section>
