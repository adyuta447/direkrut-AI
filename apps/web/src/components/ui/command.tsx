...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent
        className={cn(
          "top-[10%] translate-y-0 overflow-hidden rounded-4xl! p-0 sm:max-w-2xl md:max-w-3xl",
          className
        )}
...
function CommandList({
  ...
  return (
    <CommandPrimitive.List
      ...
      className={cn(
        "no-scrollbar max-h-[60vh] scroll-py-1 overflow-x-hidden overflow-y-auto outline-none",
        className
      )}
      {...props}
    />
