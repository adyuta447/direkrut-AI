...
export default function GapAnalysis() {
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Gap & Growth Projection</h1>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <h2 className="text-xl font-bold text-gray-900 mb-4">Select Candidate for Analysis</h2>
        ...
        <div className="space-y-6">
                  ...
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <div className="text-right">
                      <p className="text-2xl font-bold text-gray-900">
                        ...
                        <span className="text-sm text-gray-500 font-normal"> pt gap</span>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    <div>
                      <div className="flex justify-between text-sm mb-1">
                        ...
                        <span className="font-semibold text-blue-600">{gap.currentLevel}%</span>
                      </div>
                    ...
                    <div>
                      <div className="flex justify-between text-sm mb-1">
                        ...
                        <span className="font-semibold text-green-600">{gap.requiredLevel}%</span>
                      </div>
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-6">
              <p className="text-green-900 leading-relaxed">{analysis.growthProjection}</p>
            </div>
          </div>
