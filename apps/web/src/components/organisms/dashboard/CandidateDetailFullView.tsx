...
// Default requirement evidence table items with Percentage Confidence & Multi-line Bold Evidence
const DEFAULT_EVIDENCE_ITEMS = [
  {
    req: "Golang",
    status: "Strong Match",
    confidence: "95%",
    confidenceLabel: "Sangat Kuat",
    confidenceColor: "text-emerald-700 bg-emerald-50 border-emerald-200",
    barColor: "bg-emerald-500",
    barWidth: "95%",
    evidence: (
      <>
        Mengembangkan <strong className="text-slate-900 font-bold">layanan backend Golang</strong> dengan arsitektur microservices daya tampung tinggi.
      </>
    ),
    rawEvidence: "Mengembangkan layanan backend Golang dengan arsitektur microservices daya tampung tinggi.",
  },
  {
    req: "RESTful API",
    status: "Strong Match",
    ...
    evidence: (
      <>
        Merancang dan mengimplementasikan <strong className="text-slate-900 font-bold">RESTful API yang aman &amp; scalable</strong>.
      </>
    ),
    rawEvidence: "Merancang dan mengimplementasikan RESTful API yang aman & scalable.",
  },
  {
    req: "Docker",
    status: "Strong Match",
    ...
    evidence: (
      <>
        Menggunakan <strong className="text-slate-900 font-bold">Docker containerization</strong> pada seluruh service environment production.
      </>
    ),
    rawEvidence: "Menggunakan Docker containerization pada seluruh service environment production.",
  },
  {
    req: "Kubernetes",
    status: "Partial Match",
    confidence: "60%",
    confidenceLabel: "Cukup / Parsial",
    confidenceColor: "text-amber-800 bg-amber-50 border-amber-300",
    barColor: "bg-amber-500",
    barWidth: "60%",
    evidence: (
      <>
        Pengelolaan <strong className="text-slate-900 font-bold">deployment &amp; scaling aplikasi</strong> di lingkungan production (manifest belum terurai).
      </>
    ),
    rawEvidence: "Pengelolaan deployment & scaling aplikasi di lingkungan production.",
  },
  {
    req: "AWS Cloud",
    status: "Strong Match",
    ...
    evidence: (
      <>
        Menggunakan <strong className="text-slate-900 font-bold">AWS (EKS, S3, RDS, CloudWatch)</strong> untuk infrastruktur cloud.
      </>
    ),
    rawEvidence: "Menggunakan AWS (EKS, S3, RDS, CloudWatch) untuk infrastruktur cloud.",
  },
  {
    req: "PostgreSQL",
    status: "Strong Match",
    ...
    evidence: (
      <>
        Merancang <strong className="text-slate-900 font-bold">skema database &amp; optimasi query PostgreSQL</strong> pada 5M+ record.
      </>
    ),
    rawEvidence: "Merancang skema database & optimasi query PostgreSQL pada 5M+ record.",
  },
  {
    req: "CI/CD Pipeline",
    status: "Partial Match",
    confidence: "65%",
    confidenceLabel: "Cukup",
    confidenceColor: "text-amber-800 bg-amber-50 border-amber-300",
    barColor: "bg-amber-500",
    barWidth: "65%",
    evidence: (
      <>
        Mengimplementasikan <strong className="text-slate-900 font-bold">CI/CD pipeline GitLab CI</strong> untuk otomatisasi staging.
      </>
    ),
    rawEvidence: "Mengimplementasikan CI/CD pipeline GitLab CI untuk otomatisasi staging.",
  },
  {
    req: "Microservices",
    status: "Strong Match",
    ...
    evidence: (
      <>
        Membangun <strong className="text-slate-900 font-bold">sistem terdistribusi microservices</strong> berbasis gRPC.
      </>
    ),
    rawEvidence: "Membangun sistem terdistribusi microservices berbasis gRPC.",
  },
]

// Gap & Validation items
const GAP_VALIDATION_ITEMS = [
  { req: "Kubernetes Deployment", status: "Partial Match", evidence: "Pengalaman Kubernetes disebutkan, namun belum ada rincian manifest/Helm chart di CV.", recommendation: "Tanyakan saat wawancara teknis" },
  { req: "CI/CD Pipeline Complex", status: "Partial Match", evidence: "Implementasi GitLab CI dicantumkan, namun pipeline staging/production otomatis belum terurai.", recommendation: "Verifikasi pengalaman CI/CD" },
  { req: "Durasi Kerja < 1 Tahun", status: "Perlu Divalidasi", evidence: "Terdapat 2 tempat kerja terdahulu dengan durasi kerja 8 bulan dan 10 bulan.", recommendation: "Klarifikasi alasan perpindahan kerja" },
  { req: "Sertifikasi Resmi Cloud", status: "Belum Terlampir", evidence: "Kandidat mahir AWS namun tidak melampirkan file sertifikat AWS Certified.", recommendation: "Minta sertifikat fisik jika ada" },
]
